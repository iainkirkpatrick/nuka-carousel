...
var Carousel = _react2['default'].createClass({
    ...
    return _react2['default'].createElement(
      ...
      _react2['default'].createElement(
        ...
        _extends({ className: 'slider-frame',
          ref: 'frame',
          style: (0, _objectAssign2['default'])(this.getFrameStyles(), this.props.style ? { height: this.props.style.height } : {})
        }, this.getTouchEvents(), this.getMouseEvents(), {
          onClick: this.handleClick }),
        _react2['default'].createElement(
          'ul',
          { className: 'slider-list', ref: 'list', style: (0, _objectAssign2['default'])(this.getListStyles(), this.props.style ? { height: this.props.style.height } : {}) },
          children
        )
      ),
  ...
  beginAutoPlay: function beginAutoPlay() {
    var self = this;
    this.setState({
      autoPlayInterval: setInterval(function () {
        self.state.currentSlide < self.state.slideCount - 1 ? self.nextSlide() : self.goToSlide(0);
      }, this.props.autoPlay * 1000)
    });
  },

  endAutoPlay: function endAutoPlay() {

    ...
    return (
      <div className={['slider', this.props.className || ''].join(' ')} ref="slider" style={assign(this.getSliderStyles(), this.props.style || {})}>
        <div className="slider-frame"
          ref="frame"
          style={assign(this.getFrameStyles(), this.props.style ? { height: this.props.style.height } : {})}
          {...this.getTouchEvents()}
          {...this.getMouseEvents()}
          onClick={this.handleClick}>
          <ul className="slider-list" ref="list" style={assign(this.getListStyles(), this.props.style ? { height: this.props.style.height } : {})}>
            {children}
          </ul>
        </div>
